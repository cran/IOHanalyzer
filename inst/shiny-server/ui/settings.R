  ...
  box(title = HTML('<p style="font-size:120%;">General settings</p>'),
      ...
      mainPanel(
        ...
        column(
          ...
          hr(),
          div(id = 'Settings.Constrained',
            selectInput(inputId = "Settings.Constrained.Method", label = "Constraint Penalization Method",
                        choices = c("Ignore", "Penalize Relative", "Set to value", "Penalize Absolute")),
            numericInput("Settings.Constrained.Factor",
                         label = "Penalization factor / value",
                         value = 1),
            hr(),
          ),
        ...
        column(
          ...
          box(title = HTML('<p style="font-size:120%;color:black;">Subplot Options</p>'), collapsible = T, collapsed = T, solidHeader = T, status = 'info', width = 12,
